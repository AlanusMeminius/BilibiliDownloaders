...
//     typename std::enable_if<std::is_convertible<const ProtocolType&,
//     Protocol>::value, int>::type = 0>
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(UgcArc, aid, videos, type_id, type_name,
                                   copyright, pic, title, pubdate, ctime, desc,
                                   state, duration, author, stat, dynamic,
                                   dimension)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(VideoPage, cid, page, from, part, duration,
                                   vid, weblink, dimension, first_frame)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(Subtitle, id, lan, author_doc, is_lock,
                                   author_mid, subtitle_url, author)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(UgcStat, season_id, view, danmaku, relay,
                                   favorite, coin, share, nowRank, hisRank,
                                   like)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(UgcSeason, id, title, cover, mid, intro,
                                   signState, attribute, sections, stat,
                                   ep_count, season_type)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(VideoView, bvid, aid, videos, tid, tname,
                                   copyright, pic, title, pubdate, ctime, desc,
                                   state, duration, redirect_url, mission_id,
                                   owener, stat, dynamic, cid, dimension,
                                   season_id, festival_jump_url, pages,
                                   subtitle, ugc_season)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(SubtitleInfo, allow_submit, lan, lan_doc,
                                   subtitles)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(PlayUrlDashVideo, id, base_url, backup_url,
                                   mimeType, codecs, width, height, frameRate)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(PlayUrlSupportFormat, quality, format,
                                   new_description, superscript)
};
...
public:
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(PlayUrl, accept_description, accept_quality,
                                   durl, dash, support_formats)
};
